/* kompilacja: 
        Sun C: cc -Xc test_obrazy_diablo.c -lm
        GNU C: gcc -o test_obrazy_diablo -std=c99 -pedantic -Wall test_obrazy_diablo.c -lm*/
#include<stdio.h>
#include<string.h>
#include<stdlib.h>
...
int main() {
  ...
  */
  char nazwa[] = "Lena.pgm";
  char nazwaN[] = "Lena_negatyw_diablo.pgm";
  char nazwaP20[] = "Lena_prog20_diablo.pgm";
  char nazwaP40[] = "Lena_prog40_diablo.pgm";
  char nazwaG1[] = "Lena_gamma1_diablo.pgm";
  char nazwaG3[] = "Lena_gamma3_diablo.pgm";
  char nazwaK[] = "Lena_kontur_diablo.pgm";
  char nazwaH[] = "Lena_histogram_diablo.pgm";
